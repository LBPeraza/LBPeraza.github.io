(function() {
    ...
    app.controller("footerController", ['httpNoCache', function($http) {
        ...
        $http.get('/dev/json/footer.json').success(function(data) {
            footer.lis = data;
        });
    }]);
    ...
    app.directive("aboutMe", function() {
        return {
            ...
            controller: ['httpNoCache', function($http) {
                ...
                $http.get('/dev/json/about.json').success(function(data) {
    ...
    app.directive("experience", function() {
        return {
            ...
            controller: ['httpNoCache', function($http) {
                ...
                $http.get('/dev/json/experience.json').success(function(data) {
                    work.jobs = data;
                });
            }],
    ...
    app.directive("projects", function() {
        return {
            ...
            controller: ['httpNoCache', '$timeout', function($http, $timeout) {
                ...
                $http.get('/dev/json/projects.json').success(function(data) {
    ...
    app.directive("skills", function() {
        return {
            ...
            controller: ['httpNoCache', function($http) {
                ...
                $http.get('/dev/json/skills.json').success(function(data) {
    ...
    app.directive("education", function() {
        return {
            ...
            controller: ['httpNoCache', '$timeout', function($http, $timeout) {
                ...
                $http.get('/dev/json/education.json').success(function(data) {
